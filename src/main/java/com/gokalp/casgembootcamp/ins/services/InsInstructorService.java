...
public class InsInstructorService {
	...
	public List<InsInstructorGetAllResponse> getAll() {
		...
		List<InsInstructorGetAllResponse> insInstructorGetAllResponseList = InsInstructorConverter.INSTANCE
				.convertToListOfInsInstructorGetAllResponse(instructorList);
	...
	public InsInstructorGetResponse getById(Long id) {
		...
		InsInstructorGetResponse insInstructorGetResponse = InsInstructorConverter.INSTANCE
				.convertToInsInstructorGetResponse(insInstructor);
	...
	public InsInstructorUpdateResponse update(InsInstructorUpdateRequest instructorUpdateRequest, Long id) {
		...
		InsInstructorUpdateResponse insInstructorUpdateResponse = InsInstructorConverter.INSTANCE
				.convertToInsInstructorUpdateResponse(instructor);
